...
public enum Potion
{
	...
	ANTIPOISON("Antipoison", "Marrentill", "Unicorn horn dust, Unicorn horn", "Marrentill potion (unf)", "Marrentill seed", 5),
	...
	RESTORE_POTION("Restore potion", "Harralander", "Red spiders' eggs", "Harralander potion (unf)", "Harralander seed", 22),
	...
	SUPERANTIPOISON("Superantipoison", "Irit leaf", "Unicorn horn dust, Unicorn horn", "Irit potion (unf)", "Irit seed", 48),
	...
	SUPER_RESTORE("Super restore", "Snapdragon", "Red spiders' eggs", "Snapdragon potion (unf)", "Snapdragon seed", 63),
	SANFEW_SERUM("Sanfew serum", "Unicorn horn dust, Unicorn horn", "Snake weed, Nail beast nails", "Mixture - step 2(4)", null, 65),
	...
	WEAPON_POISON_PLUS("Weapon Poison+", "Cactus spine", "Red spiders' eggs", "Weapon poison+ (unf)", null, 73),
